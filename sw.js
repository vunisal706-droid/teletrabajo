const CACHE_NAME = 'teletrabajo-capitulaciones-v17';
...
self.addEventListener('install', event => {
  ...
  event.waitUntil(
    caches.open(CACHE_NAME)
      .then(cache => {
        console.log('Service Worker v17: Caching files');
      ...
      .then(() => {
        console.log('Service Worker v17: Skip waiting');
...
self.addEventListener('activate', event => {
  console.log('Service Worker v17: Activating...');
  event.waitUntil(
    caches.keys().then(cacheNames => {
      ...
      console.log('Service Worker v17: Claiming clients');
